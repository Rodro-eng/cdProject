...
class ARLiveSTProvider : MainAPI() {
    override var mainUrl = "https://go.skym3u.top"
    override var name = "ARLiveST"
    ...
    companion object {
        private const val M3U_URL = "https://go.skym3u.top/3f73.m3u"
    }
    ...
    override val mainPage = mainPageOf(
        "⭐ DIRECTV ⭐" to "⭐ DirecTV",
        "⭐ FLOW ⭐" to "⭐ Flow",
        "⭐ TELECENTRO ⭐" to "⭐ Telecentro",
        "⭐ ANTINA ⭐" to "⭐ Antina",
        "⭐ ASTRA 4  ⭐" to "⭐ Astra 4",
        "LATINO 3" to "Latino 3",
        "KIDS" to "Kids",
    )
    ...
    override suspend fun loadLinks(
        ...
        val channelName = channel?.name ?: "ARLiveST"
