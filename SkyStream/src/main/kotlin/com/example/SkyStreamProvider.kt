...
class SkyStreamProvider : MainAPI() {
    override var mainUrl = "https://go.skym3u.top"
    override var name = "SkyStream"
    ...
    companion object {
        private const val M3U_URL = "https://go.skym3u.top/bcbd.m3u"
    }
    ...
    private fun parseM3u(content: String): List<M3uChannel> {
        ...
        while (i < lines.size) {
            ...
            if (line.startsWith("#EXTINF:")) {
                ...
                // Find the next URL line (skip comments and EXTVLCOPT/KODIPROP lines)
                var j = i + 1
                while (j < lines.size) {
    ...
    override suspend fun loadLinks(
        ...
        val channelName = channel?.name ?: "SkyStream"
